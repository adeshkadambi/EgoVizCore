    ...
    <>
      <div className='min-h-full flex flex-col justify-center py-12 sm:px-6 lg:px-8 mt-4'>
        <div className='sm:mx-auto sm:w-full sm:max-w-md'>
          <img className='mx-auto h-24 w-auto' src='/logo.svg' alt='EgoViz' />
          <h1 className='mt-4 text-center text-4xl font-semibold text-slate-800'>
            EgoViz
          </h1>
          <p className='mt-4 text-center text-sm font-medium leading-5 text-slate-400'>
            A web-based CDSS for monitoring hand function.
          </p>
        </div>
